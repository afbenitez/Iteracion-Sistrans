...
//			e.printStackTrace();
    	...
    	try
		{
			...
			VOAdministrador tipoBebida1 = parranderos.adicionarTipoBebida (nombreTipoBebida1);
			...
			VOAdministrador tipoBebida2 = parranderos.adicionarTipoBebida (nombreTipoBebida2);
			lista = parranderos.darVOTiposBebida();
...
//			e.printStackTrace();
		...
		try
		{
			...
			VOAdministrador tipoBebida2 = parranderos.adicionarTipoBebida (nombreTipoBebida1);
